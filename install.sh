...
if [[ "$OSTYPE" == "darwin"* ]]; then
  if [[ $(uname -m) == "x86_64" ]]; then
    curl -LJO https://github.com/cploutarchou/MicroGO/releases/download/v1.0.9/microGo-MacOS-x86_64 &
    spinner $!
    mv microGo-MacOS-x86_64 /Users/"$userDir"/go/bin/microGo
  else
    curl -LJO https://github.com/cploutarchou/MicroGO/releases/download/v1.0.9/microGo-MacOS-ARM64 &
    spinner $!
  ...
  if [[ $(uname -m) == "x86_64" ]]; then
    curl -LJO https://github.com/cploutarchou/MicroGO/releases/download/v1.0.9/microGo-Linux-x86_64 &
    spinner $!
    mv microGo-Linux-x86_64 ~/go/bin/microGo
  else
    curl -LJO https://github.com/cploutarchou/MicroGO/releases/download/v1.0.9/microGo-Linux-ARM64 &
    spinner $!
